...
public class FrmListadoNotasSalida extends javax.swing.JFrame implements IFormActive{
    ...
    /** Creates new form ListadoNotasSalida */
    public FrmListadoNotasSalida() {
        initComponents();
        ...
        this.defaultTable.addColumn("Fecha de Salida");
        ...
        this.tblNotasSalida.setModel(defaultTable);
        
        tblNotasSalida.setRowHeight(25);
        TableColumnModel columnModel = tblNotasSalida.getColumnModel();
    ...
    public void loadTable()
    {
       try{
            ...
            tblNotasSalida.getColumnModel().getColumn(5).setCellRenderer(foreColor);
    ...
    private void initComponents() {
        ...
        tblNotasSalida = new javax.swing.JTable();
        ...
        setTitle("Listado de Notas de Salida");
        setResizable(false);
        ...
        btnNew.setText("NUEVA NOTA DE SALIDA");
        ...
        btnAnularNota.setText("ANULAR NOTA SALIDA");
        ...
        tblNotasSalida.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        tblNotasSalida.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "ID", "FECHA DE SALIDA", "SERIE", "NÚMERO", "OBSERVACIONES", "ESTADO", "USUARIO"
            }
        ));
        jScrollPane1.setViewportView(tblNotasSalida);
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(19, 19, 19)
                                .addComponent(dtpFechaInicio, javax.swing.GroupLayout.PREFERRED_SIZE, 170, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(57, 57, 57)
                                .addComponent(jLabel2)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(dtpFechaFinal, javax.swing.GroupLayout.PREFERRED_SIZE, 156, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(18, 18, 18)
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(btnAnularNota, javax.swing.GroupLayout.DEFAULT_SIZE, 194, Short.MAX_VALUE)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            .addGap(1, 1, 1)
                            .addComponent(dtpFechaInicio, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addComponent(dtpFechaFinal, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
    ...
    private void btnNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNewActionPerformed
        ...
        FrmNotaSalida formNS = new FrmNotaSalida();
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        try{
            ...
            int tipoMovId = 2; //2=NOTA DE INGRESO
    ...
    private void btnAnularNotaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAnularNotaActionPerformed
        // TODO add your handling code here:
        if(tblNotasSalida.getRowCount() == 0){
            JOptionPane.showMessageDialog(null, "No existe registros de notas de salida", Module.titleMessage, JOptionPane.CANCEL_OPTION);
            return;
        }
        if(tblNotasSalida.getSelectedRow() == -1) {
            JOptionPane.showMessageDialog(null, "Seleccione una nota de salida para anular", Module.titleMessage, JOptionPane.CANCEL_OPTION);
            return;
        }
        
        int pos = tblNotasSalida.getSelectedRow();
        int id = (int) tblNotasSalida.getValueAt(pos, 0);
        String serie = tblNotasSalida.getValueAt(pos, 2).toString();
        String numero = tblNotasSalida.getValueAt(pos, 3).toString();
        String estado = tblNotasSalida.getValueAt(pos, 5).toString();
        
        if(estado.equals("ANULADO")){
            JOptionPane.showMessageDialog(null, "La nota de salida ya está anulada", Module.titleMessage, JOptionPane.CANCEL_OPTION);
            return;
        }
    ...
    private void btnExportarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExportarActionPerformed
        ...
        try{
            ...
            String fileName = "Reporte-de-notas-de-salida.xls";
            String titleReport = "Reporte General de Notas de Salida";
            String sheetName = "Notas de Salida";
            ...
            String[] columnsHead = {"Id", "Fecha de Salida", "Serie", "Número", "Observaciones", "Estado", "Usuario"};
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmListadoNotasSalida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmListadoNotasSalida().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tblNotasSalida;
