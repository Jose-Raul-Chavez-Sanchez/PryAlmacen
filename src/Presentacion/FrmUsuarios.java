...
public class FrmUsuarios extends javax.swing.JFrame {
    ...
    public FrmUsuarios() {
        ...
        if(id != 0){//SI EXISTE UN REGISTRO
            try{
                //SE LLAMAR AL METODO BUSCAR POR ID Y SE ALMACENA EN UN ARRAY
                ArrayList arrayList = clsUsuario.searchById(id);
                //ACCEDEMOS AL PRIMER VALOR DE REGISTRO
                EUsuarios usuario = (EUsuarios)arrayList.get(0);
                //ASIGNAMOS EL TIPO DE USUARIO AL COMBOBOX
        this.setSelectedValue(cbxTipoUsuario, usuario.getTipoRol());
                //ASIGNAMOS LOS DATOS RECUPERADOS A CADA CAJA DE TEXTO
        ...
        this.txtClave.setText(Hash.decrypt(usuario.getClave()));
             ...
             ex.toString(), Module.titleMessage, 
