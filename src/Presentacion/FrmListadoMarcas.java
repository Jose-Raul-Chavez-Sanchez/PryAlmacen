    ...
    public final void loadTable(){
        try{
            ...
            for (int i = 0; i < arrayList.size(); i++) {
                ...
                this.defaultTable.setValueAt(marca.getDescripcion(), i, 1);
                this.defaultTable.setValueAt(marca.getEstado(), i, 2);
            }
            
            EColorTableCell foreColor = new EColorTableCell();
            foreColor.setColumnIndex(2);
            tblMarcas.getColumnModel().getColumn(2).setCellRenderer(foreColor);
